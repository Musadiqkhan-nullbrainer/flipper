...
const PreviousRolls = () => {
	...
	return (
		<div className="previous-roll-wrapper">
			...
			<div className="d-flex alig-items-center justofy-content-center flex-wrap">
				<img src={"/images/gray-coin.svg"} alt="coin" className="mr-1 ml-2" />
				<img src={"/images/gray-coin.svg"} alt="coin" className="mr-1" />

				<img src={"/images/golden-coin.svg"} alt="coin" className="mr-1" />
				<img src={"/images/golden-coin.svg"} alt="coin" className="mr-1" />
				<img src={"/images/golden-coin.svg"} alt="coin" className="mr-1" />
				<img src={"/images/golden-coin.svg"} alt="coin" className="mr-1" />
				<img src={"/images/golden-coin.svg"} alt="coin" className="mr-1" />
				...
				<img src={"/images/golden-coin.svg"} alt="coin" className="mr-1" />
				<img src={"/images/golden-coin.svg"} alt="coin" className="mr-2" />
			</div>
			{/* <div
